...
/**
 * PhoneBookSearch represents the model behind the search form of `core\entities\PhoneBook`.
 */
class PhoneBookSearch extends PhoneBook
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['first_name', 'last_name', 'email', 'date_birth', 'phone'], 'safe'],
        ];
    }
    ...
    {
        $query = PhoneBook::find()->joinWith('phones');
